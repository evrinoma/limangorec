...
use App\CoinExchange\BaseChangeBlock;
use App\Vending\MachineConfiguration;
...
//region SECTION: Protected
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
             ...
             */
            $configuration = new MachineConfiguration(new BaseChangeBlock());
            $cigaretteMachine = new CigaretteMachine($configuration);
